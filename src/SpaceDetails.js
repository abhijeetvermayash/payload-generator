...
return (
    ...
    <Input placeholder='Enter Weight' type= "number"  style ={{width:400}} onChange= {e => this.setState({finalObj:{...this.state.finalObj,weight : Number(e.target.value)}})}/><br/><br/><br/>
